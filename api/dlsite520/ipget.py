...
DLSITE_URLS = [
    'www.dlsite.com', 'cdn-apac.onetrust.com', 'img.dlsite.jp', 'login.dlsite.com', 'media.dlsite.com', 'd.line-scdn.net', 'play.dlsite.com', 'download.dlsite.com', 'ci-en.dlsite.com', 'media.ci-en.jp'
]

HOSTS_TEMPLATE = """# DLsite520 Host Start
{content}
...
def get_json(session: Any) -> Optional[list]:
    url = 'https://pro-ivan.com/api/dlsite520/hosts.json'
    try:
        rs = session.get(url)

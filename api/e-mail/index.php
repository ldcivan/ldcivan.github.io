...
if (($_SERVER['REQUEST_METHOD'] === "POST"||"GET") && ($_POST["mailto"]||$_GET["mailto"]) && ($_POST["body"]||$_GET["body"])) {
    echo ("<br>以下是发送任务日志：<br>");
    sendmailto($mailto,$subject,$body."<br><hr><font size=2 color=#555>来自<a href='//pro-ivan.com/api/e-mail/'>Pro-Ivan</a>提供的发送服务<br>Do not reply.</font>");

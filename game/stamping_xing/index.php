...
<head>
    <title>醒爷戳戳乐</title>
    <meta itemprop="name" content="醒爷戳戳乐" />
    ...
    <div id="welcome" class="SHADE BOX-M">
        ...
        <div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
            <div style="margin:0 8% 0 9%;">
                <div style="font-size:2.6em; color:#FEF002;">醒爷戳戳乐</div><br />
                <div id="desc" style="display: block;font-size:1.5em; color:#fff; line-height:1.5em;">
                    从最底下的开始<br />
                    可在设置中留下记录哦<br>
                </div>
                <br />
                ...
                <div id="setting" style="display: none;">
                    ...
                    <div class="container mb-3">
                        ...
                        <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href = './rank.php';">排行榜</button>
                    </div>

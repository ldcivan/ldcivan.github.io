...
//模型的model3.json文件路径
//var baseModelPath = window.location.protocol+'//'+ window.location.host+"/live2d_on_website-master/model/";
var baseModelPath = window.location.protocol + '//' + "us.pro-ivan.com/imgbed/live2d_src/";
var modelNames = ["xingjiandan","Yujio_Live2d202106ver","umyQ","merryQ","Q版live2d","草神","Ganyu","芙宁娜"];
//var modelNames = ["芙宁娜"];
var modelPath;
//Application全局变量
var app = null;

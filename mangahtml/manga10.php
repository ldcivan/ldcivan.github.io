...
<html>
    <head>
        ...
        <title>可露希尔大减价-RedAsh-Pro_Ivan的库-漫画</title>
	...
	<script type="text/javascript">
		...
		action="null";
		    ...
		    return;
                this.src = 'http://us.pro-ivan.com/imgbed/manga/Closure_redash/'+arr[index];//路径！！！！！！！！
		document.getElementById('textfield').value = index+1;
	...
	function turnpage() {
	    ...
	    document.getElementById('textfield2').value = index+1;
	    bigimg.src = 'http://us.pro-ivan.com/imgbed/manga/Closure_redash/'+arr[index];
    ...
    <body  bgcolor=#FAFAFA>
        <center>
	<h1>可露希尔大减价-RedAsh</h1>
	<font size="2" color="#000000">请严格遵循作者的转载规约!!!<br>23，24页有RedAsh老师的版权页可以的话还请支持一下!!!</font><br><b style="color:red;">公开场合讨论本子并不光荣！</b><br><br>
	...
	<button onclick="window.location.href = '../new.html'">返回主页</button>   <button onclick="window.location.href = '../new-comic.php'">返回漫画主页</button><br>
        ...
        <div>
            <img src="http://us.pro-ivan.com/imgbed/manga/Closure_redash/00.webp" id = "bigimg" onmouseover="upNext(this)" width="75%" style="max-width: 960px;"><!--//路径！！！！！！！！-->
        </div><br>

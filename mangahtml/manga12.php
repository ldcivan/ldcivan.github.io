...
<html>
    <head>
        ...
        <title>低級ザコ淫魔の触手が不快なので感覚遮断魔法を展開しましたわっ!!-調四季-Pro_Ivan的库-漫画</title>
	...
	<script type="text/javascript">
		...
		action="null";
                ...
                else if (window.event.offsetX >= width / 2 && index != 41){//数字！！！！！！
		    ...
		    return;
                this.src = 'http://us.pro-ivan.com/imgbed/manga/KankakuShadan_ShirabeShiki/'+arr[index];//路径！！！！！！！！
		document.getElementById('textfield').value = index+1;
	...
	function turnpage() {
	    ...
	    document.getElementById('textfield2').value = index+1;
	    bigimg.src = 'http://us.pro-ivan.com/imgbed/manga/KankakuShadan_ShirabeShiki/'+arr[index];
    ...
    <body  bgcolor=#FAFAFA>
        <center>
	<h1>低級ザコ淫魔の触手が不快なので感覚遮断魔法を展開しましたわっ!!-調四季</h1>
	<font size="2" color="red">请不要分享到任何网络平台!!!</font><br>
	<a href="https://www.dlsite.com/maniax/work/=/product_id/RJ365424.html" target="_blank"><font color="#A0A0A0">如有能力请在这里支持作者!!!</font></a><br><b style="color:red;">公开场合讨论本子并不光荣！<br>本作含有触手等内容，Pro-Ivan认为可能不适合所有人阅读！</b><br><br>

	<form>
		第
    		<input type="text" name="textfield" id="textfield" size="3" value="1" oninput="value=value.replace(/[^\d]/g,'')">页 共42页<!--数字！！！-->
	...
	<button onclick="window.location.href = '../new.html'">返回主页</button>   <button onclick="window.location.href = '../new-comic.php'">返回漫画主页</button><br>
        ...
        <div>
            <img src="http://us.pro-ivan.com/imgbed/manga/KankakuShadan_ShirabeShiki/00.webp" id = "bigimg" onmouseover="upNext(this)" width="75%" style="max-width: 960px;"><!--//路径！！！！！！！！-->
        </div><br>

	<form>
		第
    		<input type="text" name="textfield2" id="textfield2" size="3" value="1" oninput="value=value.replace(/[^\d]/g,'')">页 共42页<!--数字！！！-->

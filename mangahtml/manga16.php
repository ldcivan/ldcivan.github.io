...
<html>
    <head>
        ...
        <title>雫るるの婚后粉丝交际-四水-Pro_Ivan的库-漫画</title>
	...
	<script type="text/javascript">
		...
		action="null";
		    ...
		    return;
                this.src = 'http://us.pro-ivan.com/imgbed/manga/Shizuku_Sishui/'+arr[index];//路径！！！！！！！！
		document.getElementById('textfield').value = index+1;
	...
	function turnpage() {
	    ...
	    document.getElementById('textfield2').value = index+1;
	    bigimg.src = 'http://us.pro-ivan.com/imgbed/manga/Shizuku_Sishui/'+arr[index];
    ...
    <body  bgcolor=#FAFAFA>
        <center>
	<h1>雫るるの婚后粉丝交际-四水</h1>
	<font size="2" color="#000000">请严格遵循作者的转载规约 & 25页有老师的留言！</font><br><b style="color:red;">公开场合讨论本子并不光荣！<br>本作含有非纯爱内容，Pro-Ivan认为并不适合所有玩家浏览，敬请留意！<br>本作含有过量鬼畜笑点，Pro-Ivan认为并不适合用来冲。</b><br><br>
	...
	<button onclick="window.location.href = '../new.html'">返回主页</button>   <button onclick="window.location.href = '../new-comic.php'">返回漫画主页</button><br><br>
        ...
        <div>
            <img src="http://us.pro-ivan.com/imgbed/manga/Shizuku_Sishui/00.webp" id = "bigimg" onmouseover="upNext(this)" width="75%" style="max-width: 960px;"><!--//路径！！！！！！！！-->
        </div><br>

...
<html>
    <head>
        ...
        <title>勇者酱的EX结局!-星名めいと-Pro_Ivan的库-漫画</title>
	...
	<script type="text/javascript">
		...
		action="null";
		    ...
		    return;
                this.src = 'http://us.pro-ivan.com/imgbed/manga/YuushaChanEX_HoshinaMeito/'+arr[index];//路径！！！！！！！！
		document.getElementById('textfield').value = index+1;
	...
	function turnpage() {
	    ...
	    document.getElementById('textfield2').value = index+1;
	    bigimg.src = 'http://us.pro-ivan.com/imgbed/manga/YuushaChanEX_HoshinaMeito/'+arr[index];
    ...
    <body  bgcolor=#FAFAFA>
        <center>
	<h1>勇者酱的EX结局!-星名めいと</h1>
	<font size="2" color="#000000">请知悉汉化组留言，不得使用本文档盈利！</font><br><b style="color:red;">公开场合讨论本子并不光荣！ <br>本作含有R-18g内容，请注意</b><br><br>
	...
	<button onclick="window.location.href = '../new.html'">返回主页</button>   <button onclick="window.location.href = '../new-comic.php'">返回漫画主页</button><br><br>
        ...
        <div>
            <img src="http://us.pro-ivan.com/imgbed/manga/YuushaChanEX_HoshinaMeito/00.webp" id = "bigimg" onmouseover="upNext(this)" width="75%" style="max-width: 960px;"><!--//路径！！！！！！！！-->
        </div><br>

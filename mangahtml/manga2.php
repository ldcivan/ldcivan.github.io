...
<html>
    <head>
        ...
        <title>Connect 日文原版-KOMOTA-Pro_Ivan的库-漫画</title>
	...
	<script type="text/javascript">
		...
		action="null";
                ...
                else if (window.event.offsetX >= width / 2 && index != 43){//数字！！！！！！
		    ...
		    return;
                this.src = 'http://us.pro-ivan.com/imgbed/manga/connect_jp_komota/'+arr[index];//路径！！！！！！！！
		document.getElementById('textfield').value = index+1;
	...
	function turnpage() {
	    ...
	    document.getElementById('textfield2').value = index+1;
	    bigimg.src = 'http://us.pro-ivan.com/imgbed/manga/connect_jp_komota/'+arr[index];
    ...
    <body  bgcolor=#FAFAFA>
        <center>
	<h1>Connect 日文原版-KOMOTA</h1>
	<font size="2" color="red">请不要分享到任何网络平台!!!</font><br>
	<a href="https://www.dlsite.com/maniax/circle/profile/=/maker_id/RG56795.html" target="_blank"><font color="#A0A0A0">如有能力请在这里支持作者!!!</font></a><br><b style="color:red;">公开场合讨论本子并不光荣！</b><br>本作含有触手等内容，但Pro-Ivan仍然认为读者可以尝试阅读！<br><br>

	<form>
		第
    		<input type="text" name="textfield" id="textfield" size="3" value="1" oninput="value=value.replace(/[^\d]/g,'')">页 共44页<!--数字！！！-->
	...
	<button onclick="window.location.href = '../new.html'">返回主页</button>   <button onclick="window.location.href = '../new-comic.php'">返回漫画主页</button><br>
        ...
        <div>
            <img src="http://us.pro-ivan.com/imgbed/manga/connect_jp_komota/CP00.webp" id = "bigimg" onmouseover="upNext(this)" width="75%" style="max-width: 960px;"><!--//路径！！！！！！！！-->
        </div><br>

	<form>
		第
    		<input type="text" name="textfield2" id="textfield2" size="3" value="1" oninput="value=value.replace(/[^\d]/g,'')">页 共44页<!--数字！！！-->

...
<html>
    <head>
        ...
        <title>~極秘ファイル：寄生時間~-今沢-Pro_Ivan的库-漫画</title>
    ...
    <body  bgcolor=#FAFAFA>
        <center>
	<h1>~極秘ファイル：寄生時間~-今沢</h1>
	<font size="2" color="#000000">可能的话，请在<a href="https://www.fanbox.cc/@animarcat/posts">Fanbox</a>支持原作者@今沢！</font><br><b style="color:red;">公开场合讨论本子并不光荣！<br>转载请保留作者信息！</b><br><br>
    ...
    <script>
        ...
        document.getElementById('bigimg').src = 'http://us.pro-ivan.com/imgbed/manga/' + title + '/' + arr[0];
    </script>
    </body>
</html>
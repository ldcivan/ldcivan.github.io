...
<html>
    <head>
        ...
        <title>睡眠ゲーム-SiviruLuke-Pro_Ivan的库-漫画</title>
	...
	<script type="text/javascript">
		...
		action="null";
                ...
                else if (window.event.offsetX >= width / 2 && index != 24){//数字！！！！！！
		    ...
		    return;
                this.src = 'http://us.pro-ivan.com/imgbed/manga/xiao_hirika_SilverLuke/'+arr[index];//路径！！！！！！！！
		document.getElementById('textfield').value = index+1;
	...
	function turnpage() {
	    ...
	    document.getElementById('textfield2').value = index+1;
	    bigimg.src = 'http://us.pro-ivan.com/imgbed/manga/xiao_hirika_SilverLuke/'+arr[index];
    ...
    <body  bgcolor=#FAFAFA>
        <center>
	<h1>睡眠ゲーム-SiviruLuke</h1>
	<font size="2" color="#000000">请严格遵循作者的转载规约!!!<br>&<br>末页有老师的一些话，可以的话还请到<a href="https://space.bilibili.com/10579112" target="_blank">Bilibili</a>支持一下!!!</font><br><br>

	<form>
		第
    		<input type="text" name="textfield" id="textfield" size="3" value="1" oninput="value=value.replace(/[^\d]/g,'')">页 共25页<!--数字！！！-->
	...
	<button onclick="window.location.href = '../new.html'">返回主页</button>   <button onclick="window.location.href = '../new-comic.php'">返回漫画主页</button><br>
        ...
        <div>
            <img src="http://us.pro-ivan.com/imgbed/manga/xiao_hirika_SilverLuke/00.webp" id = "bigimg" onmouseover="upNext(this)" width="75%" style="max-width: 960px;"><!--//路径！！！！！！！！-->
        </div><br>

	<form>
		第
    		<input type="text" name="textfield2" id="textfield2" size="3" value="1" oninput="value=value.replace(/[^\d]/g,'')">页 共25页<!--数字！！！-->

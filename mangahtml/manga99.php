...
<html>
    <head>
        ...
        <title>凯尔希的催眠时刻-Saluky-Pro_Ivan的库-漫画</title>
	...
	<script type="text/javascript">
		...
		action="null";
                ...
                else if (window.event.offsetX >= width / 2 && index != 18){//数字！！！！！！
		    ...
		    return;
                this.src = 'http://us.pro-ivan.com/imgbed/manga/Kkltsit_hypnosis_saluky/'+arr[index];//路径！！！！！！！！
		document.getElementById('textfield').value = index+1;
	...
	function turnpage() {
	    ...
	    document.getElementById('textfield2').value = index+1;
	    bigimg.src = 'http://us.pro-ivan.com/imgbed/manga/Kkltsit_hypnosis_saluky/'+arr[index];
	    window.scrollBy(0,-10000);  
    	    scrolldelay = setTimeout('pageScroll()',100);}//路径！！！！！！！！
	function turnpage2() {
    ...
    <body  bgcolor=#FAFAFA>
        <center>
	<h1>凯尔希的催眠时刻-Saluky</h1>
	<font size="2" color="#000000">请严格遵循作者的转载规约!!!</font><br><b style="color:red;">公开场合讨论本子并不光荣！</b><br><br>

	<form>
		第
    		<input type="text" name="textfield" id="textfield" size="3" value="1" oninput="value=value.replace(/[^\d]/g,'')">页 共19页<!--数字！！！-->
	...
	<button onclick="window.location.href = '../new.html'">返回主页</button>   <button onclick="window.location.href = '../new-comic.php'">返回漫画主页</button><br>
        ...
        <div>
            <img src="http://us.pro-ivan.com/imgbed/manga/Kkltsit_hypnosis_saluky/1.webp" id = "bigimg" onmouseover="upNext(this)" width="75%"><!--//路径！！！！！！！！-->
        </div><br>

	<form>
		第
    		<input type="text" name="textfield2" id="textfield2" size="3" value="1" oninput="value=value.replace(/[^\d]/g,'')">页 共19页<!--数字！！！-->

...
function set$3(element, value, index) {
    ...
    const currentOffset = get$3(element);
...
const customAttr$3 = 'mdui-collapse';
$(() => {
...
$(() => {
    $document.on('click', `[${customAttr$7}]`, function () {
        ...
        let instance = $dialog.data(dataName$3);
        if (!instance) {
 ...
 * 当前打开着的 Snackbar
 */
let currentInst$3 = null;
/**
 * 队列名
 */
const queueName$3 = '_mdui_snackbar';
class Snackbar {
    constructor(options) {
        /**
         * 配置参数

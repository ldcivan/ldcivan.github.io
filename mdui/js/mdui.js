...
(function (global, factory) {
  ...
  function handle(self, deferred) {
    ...
    self._handled = true;
    Promise$3._immediateFn(function() {
  ...
  function resolve(self, newValue) {
    try {
      ...
      if (
        ...
        if (newValue instanceof Promise$3) {
          self._state = 3;
  ...
  function finale(self) {
    if (self._state === 2 && self._deferreds.length === 0) {
      Promise$3._immediateFn(function() {
        if (!self._handled) {
          Promise$3._unhandledRejectionFn(self._value);
        }
      });
    }
  ...
  Promise$3.prototype['finally'] = finallyConstructor;

  Promise$3.all = function(arr) {
  ...
  Promise$3.resolve = function(value) {
    if (value && typeof value === 'object' && value.constructor === Promise$3) {
      return value;
    }
  ...
  Promise$3.reject = function(value) {
    return new Promise$3(function(resolve, reject) {
      reject(value);
    });
  };

  Promise$3.race = function(arr) {
    return new Promise$3(function(resolve, reject) {
      if (!isArray(arr)) {
      ...
      for (var i = 0, len = arr.length; i < len; i++) {
        Promise$3.resolve(arr[i]).then(resolve, reject);
      }
    });
  };

  // Use polyfill for setImmediate for performance gains
  Promise$3._immediateFn =
    // @ts-ignore
  ...
  Promise$3._unhandledRejectionFn = function _unhandledRejectionFn(err) {
  ...
  function each(target, callback) {
      if (isArrayLike(target)) {
          ...
          for (var i$3 = 0; i$3 < keys.length; i$3 += 1) {
              if (callback.call(target[keys[i$3]], keys[i$3], target[keys[i$3]]) === false) {
                  return target;
              }
          }
      }
  ...
  $.fn.on = function (types, selector, data, callback, one) {
      ...
      if (isObjectLike(types)) {
          ...
          each(types, function (type, fn) {
              ...
              // @ts-ignore
              this$3.on(type, selector, data, fn, one);
          });
          return this;
      }
  ...
  function set$3(element, value, index) {
      var $element = $(element);
      var position = $element.css('position');
      if (position === 'static') {
          $element.css('position', 'relative');
      }
      var currentOffset = get$3(element);
  ...
  $.fn.replaceAll = function (target) {
      ...
      return $(target).map(function (index, element) {
          $(element).replaceWith(index ? this$3.clone() : this$3);
          return this$3.get();
      });
  };
  ...
  Headroom.prototype.onScroll = function onScroll () {
      ...
      this.rafId = window.requestAnimationFrame(function () {
          ...
          var direction = currentScrollY > this$3.lastScrollY ? 'down' : 'up';
          var tolerance = this$3.options.tolerance[direction];
          var scrolled = Math.abs(currentScrollY - this$3.lastScrollY);
          var toleranceExceeded = scrolled >= tolerance;
          if (currentScrollY > this$3.lastScrollY &&
              currentScrollY >= this$3.options.offset &&
              toleranceExceeded) {
              this$3.unpin();
          }
          else if ((currentScrollY < this$3.lastScrollY && toleranceExceeded) ||
              currentScrollY <= this$3.options.offset) {
              this$3.pin();
          }
          this$3.lastScrollY = currentScrollY;
      });
  };
  /**
   * 触发组件事件
  ...
  Headroom.prototype.pin = function pin () {
      ...
      this.$element
          ...
          .transitionEnd(function () { return this$3.transitionEnd(); });
  };
  /**
   * 使元素隐藏
   */
  ...
  Headroom.prototype.enable = function enable () {
      ...
      $window.on('scroll', function () { return this$3.onScroll(); });
  };
  /**
   * 禁用 headroom 插件
   */
  Headroom.prototype.disable = function disable () {
      ...
      this.$element
          ...
          .removeClass(this.options.pinnedClass)
          .removeClass(this.options.unpinnedClass);
      $window.off('scroll', function () { return this$3.onScroll(); });
  ...
  CollapseAbstract.prototype.open = function open (item) {
      ...
      $content
          ...
          .transitionEnd(function () { return this$3.transitionEnd($content, $item); });
  ...
  CollapseAbstract.prototype.openAll = function openAll () {
      ...
      this.getItems().each(function (_, element) { return this$3.open(element); });
  };
  /**
   * 关闭所有面板项
   */
  CollapseAbstract.prototype.closeAll = function closeAll () {
      ...
      this.getItems().each(function (_, element) { return this$3.close(element); });
  };
  ...
  var customAttr$3 = 'mdui-collapse';
  $(function () {
      mdui.mutation(("[" + customAttr$3 + "]"), function () {
          new mdui.Collapse(this, parseOptions(this, customAttr$3));
      });
  });
  ...
  Table.prototype.updateTdCheckbox = function updateTdCheckbox () {
      ...
      this.$tdRows.each(function (_, row) {
          ...
          if (!this$3.selectable) {
              return;
          }
          // 创建 DOM
          var $checkbox = $(this$3.createCheckboxHTML('td'))
              .prependTo($row)
          ...
          this$3.$tdCheckboxs = this$3.$tdCheckboxs.add($checkbox);
      });
  };
  /**
   * 更新表头的 checkbox
  ...
  Table.prototype.updateThCheckbox = function updateThCheckbox () {
      ...
      this.$thCheckbox = $(this.createCheckboxHTML('th'))
          ...
          .find('input[type="checkbox"]')
          .on('change', function () {
          var isCheckedAll = this$3.$thCheckbox[0].checked;
          this$3.selectedRow = isCheckedAll ? this$3.$tdRows.length : 0;
          this$3.$tdCheckboxs.each(function (_, checkbox) {
              checkbox.checked = isCheckedAll;
          });
          this$3.$tdRows.each(function (_, row) {
              isCheckedAll
  ...
  var Fab = function Fab(selector, options) {
      ...
      if (this.options.trigger === 'hover') {
          this.$btn.on('touchstart mouseenter', function () { return this$3.open(); });
          this.$element.on('mouseleave', function () { return this$3.close(); });
      }
      if (this.options.trigger === 'click') {
          this.$btn.on(startEvent, function () { return this$3.open(); });
      }
      // 触摸屏幕其他地方关闭快速拨号
  ...
  Fab.prototype.open = function open () {
      ...
      this.$dialBtns.each(function (index, btn) {
          var delay = (15 * (this$3.$dialBtns.length - index)) + "ms";
      ...
      this.$dialBtns.first().transitionEnd(function () {
          if (this$3.$btn.hasClass('mdui-fab-opened')) {
              this$3.state = 'opened';
              this$3.triggerEvent('opened');
          }
      });
  };
  /**
  ...
  Fab.prototype.close = function close () {
      ...
      this.$dialBtns.last().transitionEnd(function () {
          ...
          this$3.state = 'closed';
          this$3.triggerEvent('closed');
          this$3.$dial.css('height', 0);
      });
  };
  /**
   * 切换快速拨号菜单的打开状态
  ...
  var Select = function Select(selector, options) {
      ...
      $document.on('click touchstart', function (event) {
          var $target = $(event.target);
          if (this$3.isOpen() &&
              !$target.is(this$3.$element) &&
              !contains(this$3.$element[0], $target[0])) {
              this$3.close();
          }
      });
  };
  ...
  Select.prototype.handleUpdate = function handleUpdate () {
      ...
      this.$native.find('option').each(function (index, option) {
          ...
          var selected = this$3.selectedValue === value;
          itemsData.push({
              value: value,
              text: text,
              disabled: disabled,
          ...
          if (selected) {
              this$3.selectedText = text;
              this$3.selectedIndex = index;
          }
          this$3.$items = this$3.$items.add('<div class="mdui-select-menu-item mdui-ripple"' +
              (disabled ? ' disabled' : '') +
              (selected ? ' selected' : '') +
              ">" + text + "</div>");
      });
  ...
  Select.prototype.open = function open () {
      ...
      this.$menu.transitionEnd(function () { return this$3.transitionEnd(); });
  };
  /**
   * 关闭下拉菜单
   */
  ...
  var Tab = function Tab(selector, options) {
      ...
      this.setActive();
      // 监听窗口大小变化事件，调整指示器位置
      $window.on('resize', $.throttle(function () { return this$3.setIndicatorPosition(); }, 100));
      // 监听点击选项卡事件
      this.$tabs.each(function (_, tab) {
          this$3.bindTabEvent(tab);
      });
  };
  /**
   * 指定选项卡是否已禁用
  ...
  Tab.prototype.bindTabEvent = function bindTabEvent (tab) {
      ...
      var clickEvent = function () {
          // 禁用状态的选项卡无法选中
          if (this$3.isDisabled($tab)) {
              return false;
          }
          this$3.activeIndex = this$3.$tabs.index(tab);
          this$3.setActive();
      };
  ...
  Tab.prototype.setActive = function setActive () {
      ...
      this.$tabs.each(function (index, tab) {
          ...
          // 设置选项卡激活状态
          if (index === this$3.activeIndex && !this$3.isDisabled($tab)) {
              if (!$tab.hasClass('mdui-tab-active')) {
                  this$3.triggerEvent('change', this$3.$element, {
                      index: this$3.activeIndex,
                      id: targetId.substr(1),
                  });
                  this$3.triggerEvent('show', $tab);
                  $tab.addClass('mdui-tab-active');
              }
              $(targetId).show();
              this$3.setIndicatorPosition();
          }
          else {
  ...
  Tab.prototype.handleUpdate = function handleUpdate () {
      ...
      $newTabs.each(function (index, tab) {
          ...
          if (oldTabsElement.indexOf(tab) < 0) {
              this$3.bindTabEvent(tab);
              if (this$3.activeIndex === -1) {
                  this$3.activeIndex = 0;
              }
              else if (index <= this$3.activeIndex) {
                  this$3.activeIndex++;
              }
          }
      });
  ...
  var Drawer = function Drawer(selector, options) {
      ...
      $window.on('resize', $.throttle(function () {
          if (this$3.isDesktop()) {
              // 由手机平板切换到桌面时
              // 如果显示着遮罩，则隐藏遮罩
              if (this$3.overlay && !this$3.options.overlay) {
                  $.hideOverlay();
                  this$3.overlay = false;
                  $.unlockScreen();
              }
              // 没有强制关闭，则状态为打开状态
              if (!this$3.$element.hasClass('mdui-drawer-close')) {
                  this$3.state = 'opened';
              }
          }
          else if (!this$3.overlay && this$3.state === 'opened') {
              // 由桌面切换到手机平板时。如果抽屉栏是打开着的且没有遮罩层，则关闭抽屉栏
              if (this$3.$element.hasClass('mdui-drawer-open')) {
                  $.showOverlay();
                  this$3.overlay = true;
                  $.lockScreen();
                  $('.mdui-overlay').one('click', function () { return this$3.close(); });
              }
              else {
                  this$3.state = 'closed';
              }
      ...
      this.$element.find('[mdui-drawer-close]').each(function (_, close) {
          $(close).on('click', function () { return this$3.close(); });
      });
      this.swipeSupport();
  };
  /**
  ...
  Drawer.prototype.open = function open () {
      ...
      if (!this.isDesktop() || this.options.overlay) {
          this.overlay = true;
          $.showOverlay().one('click', function () { return this$3.close(); });
          $.lockScreen();
      }
  };
  /**
  ...
  var Dialog = function Dialog(selector, options) {
      ...
      this.$element.find('[mdui-dialog-cancel]').each(function (_, cancel) {
          $(cancel).on('click', function () {
              this$3.triggerEvent('cancel');
              if (this$3.options.closeOnCancel) {
                  this$3.close();
              }
          });
      });
      ...
      this.$element.find('[mdui-dialog-confirm]').each(function (_, confirm) {
          $(confirm).on('click', function () {
              this$3.triggerEvent('confirm');
              if (this$3.options.closeOnConfirm) {
                  this$3.close();
              }
          });
      });
  ...
  Dialog.prototype.open = function open () {
      ...
      if ((currentInst &&
          ...
          queue(queueName, function () { return this$3.doOpen(); });
          return;
      }
      this.doOpen();
  };
  ...
  Dialog.prototype.close = function close (historyBack) {
      ...
      setTimeout(function () {
          ...
          currentInst = null;
          this$3.state = 'closing';
          this$3.triggerEvent('close');
          ...
          this$3.$element
              ...
              .transitionEnd(function () { return this$3.transitionEnd(); });
          if (this$3.options.history && !queue(queueName).length) {
              if (!historyBack) {
                  window.history.back();
              }
              $window.off('hashchange', this$3.hashchangeEvent);
          }
          // 关闭旧对话框，打开新对话框。
  ...
  $(function () {
      $document.on('click', ("[" + customAttr$7 + "]"), function () {
          ...
          var instance = $dialog.data(dataName$3);
          if (!instance) {
              instance = new mdui.Dialog($dialog, options);
              $dialog.data(dataName$3, instance);
          }
          instance.open();
      });
  });
  ...
  Tooltip.prototype.open = function open (options) {
      ...
      if (this.options.delay) {
          this.timeoutId = setTimeout(function () { return this$3.doOpen(); }, this.options.delay);
      }
      else {
          this.timeoutId = null;
          this.doOpen();
   ...
   * 当前打开着的 Snackbar
   */
  var currentInst$3 = null;
  /**
   * 队列名
   */
  var queueName$3 = '_mdui_snackbar';
  ...
  Snackbar.prototype.open = function open () {
      ...
      if (currentInst$3) {
          queue(queueName$3, function () { return this$3.open(); });
          return;
      }
      currentInst$3 = this;
      // 开始打开
      ...
      this.$element.transitionEnd(function () {
          if (this$3.state !== 'opening') {
              return;
          }
          this$3.state = 'opened';
          this$3.options.onOpened(this$3);
          // 有按钮时绑定事件
          if (this$3.options.buttonText) {
              this$3.$element.find('.mdui-snackbar-action').on('click', function () {
                  this$3.options.onButtonClick(this$3);
                  if (this$3.options.closeOnButtonClick) {
                      this$3.close();
                  }
              });
          }
          // 点击 snackbar 的事件
          this$3.$element.on('click', function (event) {
              if (!$(event.target).hasClass('mdui-snackbar-action')) {
                  this$3.options.onClick(this$3);
              }
          });
          // 点击 Snackbar 外面的区域关闭
          if (this$3.options.closeOnOutsideClick) {
              $document.on(startEvent, this$3.closeOnOutsideClick);
          }
          // 超时后自动关闭
          if (this$3.options.timeout) {
              this$3.timeoutId = setTimeout(function () { return this$3.close(); }, this$3.options.timeout);
          }
      });
  };
  /**
  ...
  Snackbar.prototype.close = function close () {
      ...
      this.setPosition('close');
      this.$element.transitionEnd(function () {
          if (this$3.state !== 'closing') {
              return;
          }
          currentInst$3 = null;
          this$3.state = 'closed';
          this$3.options.onClosed(this$3);
          this$3.$element.remove();
          dequeue(queueName$3);
      });
  };
  ...
  var Menu = function Menu(anchorSelector, menuSelector, options) {
      ...
      // 点击触发菜单切换
      this.$anchor.on('click', function () { return this$3.toggle(); });
      // 点击菜单外面区域关闭菜单
      $document.on('click touchstart', function (event) {
          var $target = $(event.target);
          if (this$3.isOpen() &&
              !$target.is(this$3.$element) &&
              !contains(this$3.$element[0], $target[0]) &&
              !$target.is(this$3.$anchor) &&
              !contains(this$3.$anchor[0], $target[0])) {
              this$3.close();
          }
      });
      // 点击不含子菜单的菜单条目关闭菜单
      ...
      // 窗口大小变化时，重新调整菜单位置
      $window.on('resize', $.throttle(function () { return this$3.readjust(); }, 100));
  };
  /**
   * 是否为打开状态
   */

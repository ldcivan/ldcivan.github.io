...
if(!isset($_SESSION['recheck'])){
    ...
    exit('<div id="divcss"><center>
        ...
        <form method="post">
            ...
            <input type="submit" value="确定" /><br>维护中，仅持有管理员密码者可进入管理
        </form>
    </center></div>
    ');
}
...
<div id="footer">
    ...
    ?>
    <a href="<?php if(isset($_SESSION['comeFrom']))echo $_SESSION['comeFrom']; else $_SESSION['passcomeFrom']; ?>"><font color="#FFFFFF">已添加通行证，点击此处安全退出本页面</font></a><br>

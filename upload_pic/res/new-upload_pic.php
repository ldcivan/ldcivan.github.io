<?php
    ...
    $white =array(".jpeg",".jpg",".png",".gif"); //白名单文件  //只允许.jpg,.png,.gif通过，Jpg这样的通通不允许
	...
	if (!empty($img['name'])){
		if($img['type']==('image/jpeg'||'image/jpg'||'image/png'||'image/gif')&&$img['error']==0){
			try{
                ...
                echo $path.$newname;
                echo '" target="_blank">此处</a><br>要获取短链请点击<a href="http://s.pro-ivan.com/?u=http://us.pro-ivan.com'.$path.$newname.'">此处</a>';
    			header("refresh:10;url=/new-upload.html");
